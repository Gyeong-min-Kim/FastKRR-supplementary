...
- They are loaded by `FastKRR-paper.pdf` during compilation.
...
by running `replication/full_replication_code.R`. The regenerated files
will be saved in `replication/output/` and may differ slightly in timing
