...
submission and are provided so that the tables and figures can be
...
generate the corresponding tables and figures in the revised manuscript.
...
### Table 3: FastKRR computation time and predictive accuracy
...
### Table 4: approximation-method comparison
...
### Table 5: hyperparameter-selection comparison
